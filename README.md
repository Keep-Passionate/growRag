...
2026-09-06 最新开发：0.4.0 新增独立 PRE 来源记录、统一候选卡建库与真实32来源／16目标批量入口。用户已授权整批累计5元估算预算；实际实验结果另记，不由代码完成预断效果。先看 [正式开发首批说明](docs/pre_pilot_v1.md)。候选选择仍是词面匹配诊断，不是自动可信门控。
