...
**2026-09-08 后续优先入口：** [两条主线聚焦 12 篇：经验表示与适用性＋低成本选择](2026-09-08_memory_cards/README.md)。按最新讨论重组，不是 12 篇新发现；旧包保留，已导入者可仅跟随新导读。下方四方向与更早顺序均作为历史。

**2026-09-08 新入口：** [四个研究方向：30 篇整合与新增 8 篇包](2026-09-08_directions/README.md)。针对最新 QPP、词汇不匹配、意图漂移与记忆选择讨论重新分组；已有旧论文可只导入新增包。旧包保留不覆盖，下面仍为 09-05 历史阅读安排。
