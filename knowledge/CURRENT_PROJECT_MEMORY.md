...
更新日期：2026-09-24（S2G/DualRAG精读、记忆近邻排重、DualRAG适配真实8题）
状态：新增独立DualRAG非FT两轮适配，8道原train/debug配对完整完成，53次真实Qwen；BASE EM1/8 F1.2083、适配EM6/8 F1.75。仅小候选池功能诊断，不是原论文复现；没有历史记忆或模型训练。发现2题空证据误停、来源链与截断问题。累计723请求，已知估算0.1165764元、保守预留0.9119286元、历史1费用未知，累计授权50元。原6PRE卡/24检查题、旧失败run与原分数不变；无新增记忆收益证据。
