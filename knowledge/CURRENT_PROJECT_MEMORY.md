...
更新日期：2026-09-07
状态：用户同意持续开发，既有开发分支推送授权有效。0.4.0 真实 PRE 首批已完成：32源1卡、16目标全部无卡；BASE 6/16、FRESH 5/16、REUSE未执行。145次真实API约0.0209324元，不能宣称记忆效果。随后仅零API审计与报告修正。自动可信选择仍待做，QPP 未接在线门控，无新参数训练。创新仍为待证假设；文档层后置。9 月 8 日文献跟进不扩权为付费实验。
