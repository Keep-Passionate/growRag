...
状态：v4作者控制流程API迁移小测8/8完整完成；BASE与S2G的EM均6/8，F1分别.83333/.89583，差异仅来自1题部分改善。42次真实API返回固定qwen3.7-flash-2026-07-15；非原LoRA或全维基复现。容量变更通过1654项离线测试后，以干净提交beaba3e启动。累计834请求，已知估算0.1352172元、保守预留1.0170678元、历史1费用未知，授权50元。训练0、建卡0、租卡0；旧6PRE卡/24检查题不变。新32题共享池准备与验收另记，不宣称已跑它们。
