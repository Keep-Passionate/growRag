...
更新日期：2026-09-27（作者S2G实际Qwen迁移；格式/字段/截断三类故障分开）
状态：作者流程已经真实API执行，但8题工程小测尚未全部完成。v1完成5题/28调用，v2完成2题/12调用，v3完成5题/29调用；均首错停止，不能混算独立样本或冒称全量复现。v3在第6题Judge256-token截断，已停止本轮继续重跑。作者main_batch实际执行，Judge/抽取/回答改为固定qwen3.7-flash-2026-07-15，非原LoRA与全维基。1645项离线测试通过。累计792请求，已知估算0.1281978元、保守预留0.9709094元、历史1费用未知，授权50元。本轮训练0、建卡0、租卡0；旧6PRE卡/24检查题不变。
