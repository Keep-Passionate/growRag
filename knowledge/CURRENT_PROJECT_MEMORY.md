...
更新日期：2026-09-08
状态：运行代码仍为0.5.0，此前本地695测试通过，有限模式匹配不自动可信REUSE。本轮为文献方向核验、RDF与记忆更新，无运行代码改动或新模型成绩。0.4.0真实首批仍为32源1卡、16目标无卡，BASE6/16、FRESH5/16、REUSE未执行；145次API约0.0209324元。QPP门控、训练、文档层/多轮后置，创新待证；文献跟进不扩权为付费实验。
